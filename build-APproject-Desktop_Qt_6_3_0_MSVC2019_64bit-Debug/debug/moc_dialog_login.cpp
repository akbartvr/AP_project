...
#include <memory>
#include "../../APproject/dialog_login.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Dialog_Login_t, stringdata0) + ofs), len 
...
const QMetaObject Dialog_Login::staticMetaObject = { {
    ...
    qt_meta_stringdata_Dialog_Login.offsetsAndSize,
    qt_meta_data_Dialog_Login,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Dialog_Login_t
